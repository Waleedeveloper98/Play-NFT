...
const Page2 = () => {
  return (
    <div className="relative pt-10 w-full pb-40 md:h-screen lg:h-[150vh]">
      ...
      <BrandsMarque />
      <h2 className="capitalize text-4xl md:text-6xl font-semibold tracking-tight text-white text-center my-20">
        popular this week
      </h2>
      <CardsMarque />
